...
const Quiz = ({ questions }) => {
    ...
    const resetTimer = () => {
      setTimer(600); // Reset the timer to the initial value (you can adjust the time as needed)
    };
        ...
        {!showResult ? (
          ...
          <div className="result-container">
            <div className="result">
              ...
              <button onClick={onTryAgain} className="buttonTryAgain">Try Again</button>
              <button>
